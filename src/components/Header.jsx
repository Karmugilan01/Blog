  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:test-xs text-gray-500'>This is your space to think out loud, to share what matters, and to write without filters. Wheather it's one word or a thousand, your story starts right here.</p>
