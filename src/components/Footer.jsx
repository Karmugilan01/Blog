    ...
    <div className='px-4 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
        <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500'>
            <div>
                ...
                <p className='max-w-[410px] mt-6'>lorem ipsum dolor sit ame consectetue, adipisine elit, Rerum unde quaerat eveniet cumque accusamus atque qui error quo enim fugiat?</p>
            </div>
